...
namespace graduate_work
{
    class BTranslator
    {
        ...
        const string translatorKey = "trnsl.1.1.20220118T095103Z.66aa3cc3fb95eb56.c9b1713fb3085e769973cd4a2fa0d3d92612e130";
        public BTranslator()
        {
        ...
        public string Translator(string wordToTranslator, LangPair LangPair)
        {
            return tr.Translate(wordToTranslator, LangPair).Text;
        }
    }
}
